            ...
            <div>
                <div className="create-supper">
                    ...
                    <div className="create-img-container">
                        <input className="img-text-box" type="text" placeholder="Image 1" />
                        <input className="img-text-box img-text-box-center" type="text" placeholder="Image 2" />
                        <input className="img-text-box" type="text" placeholder="Image 3" />
                    </div>
